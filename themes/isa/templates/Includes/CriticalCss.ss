...
button{ font-family: inherit; font-size: 100%; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; }
button{ line-height: normal; }
button{ text-transform: none; }
button{ -webkit-appearance: button; cursor: pointer; }
html, button{ color: rgb(34, 34, 34); }
...
h1, h2, h3{ color: rgb(51, 51, 51); font-family: proxima-nova-condensed, 'Arial Narrow', sans-serif; margin-top: 1em; margin-right: 0px; margin-bottom: 0.5em; margin-left: 0px; letter-spacing: 1px; line-height: 1.2; font-weight: 600; text-rendering: optimizelegibility; }
...
.division-topbar button{ background-color: transparent; border-top-style: none; border-right-style: none; border-bottom-style: none; border-left-style: none; border-width: initial; border-color: initial; text-align: left; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; }
...
.row{ margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; max-width: 1140px; width: 100%; }
.row::before, .row::after{ content: ' '; display: table; }
.row::after{ clear: both; }
.row .row{ margin-top: 0px; margin-right: -0.9375rem; margin-bottom: 0px; margin-left: -0.9375rem; max-width: none; width: auto; }
...
.hero{ border-bottom-width: 5px; border-bottom-style: solid; border-bottom-color: rgb(255, 206, 57); position: relative; padding-top: 2em; padding-right: 0px; padding-bottom: 2em; padding-left: 0px; background-color: rgb(255, 255, 255); }
...
.nav-title{ font-family: proxima-nova-condensed, 'Arial Narrow', sans-serif; font-size: 1.25em; font-weight: 300; line-height: 44px; margin-top: 0px; margin-right: 0px; margin-bottom: 0px; margin-left: 0px; position: relative; text-align: left; text-transform: uppercase; }
.nav-title a{ color: rgb(34, 34, 34); display: block; padding-top: 0px; padding-right: 15px; padding-bottom: 0px; padding-left: 15px; }
@media screen and (min-width: 768px){
.nav-title{ display: none; }
}
.nav-title span{ border-top-left-radius: 4px 4px; border-top-right-radius: 4px 4px; border-bottom-right-radius: 4px 4px; border-bottom-left-radius: 4px 4px; width: 40px; height: 32px; position: absolute; top: 5px; right: 10px; border-top-width: 1px; border-right-width: 1px; border-bottom-width: 1px; border-left-width: 1px; border-top-style: solid; border-right-style: solid; border-bottom-style: solid; border-left-style: solid; border-top-color: rgb(213, 213, 213); border-right-color: rgb(213, 213, 213); border-bottom-color: rgb(213, 213, 213); border-left-color: rgb(213, 213, 213); background-image: -webkit-linear-gradient(top, rgb(242, 242, 242) 0%, rgb(229, 229, 229) 100%); background-attachment: initial; background-origin: initial; background-clip: initial; background-color: initial; -webkit-box-shadow: rgb(255, 255, 255) 0px 1px 0px inset; box-shadow: rgb(255, 255, 255) 0px 1px 0px inset; background-position: initial initial; background-repeat: initial initial; }
.nav-title span::after{ -webkit-box-shadow: rgb(136, 136, 136) 0px 10px 0px 1px, rgb(136, 136, 136) 0px 16px 0px 1px, rgb(136, 136, 136) 0px 22px 0px 1px; box-shadow: rgb(136, 136, 136) 0px 10px 0px 1px, rgb(136, 136, 136) 0px 16px 0px 1px, rgb(136, 136, 136) 0px 22px 0px 1px; position: absolute; left: 11px; top: 0px; display: block; width: 16px; height: 0px; color: rgb(136, 136, 136); padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; content: ''; }
.nav-main{ border-top-width: 1px; border-top-style: solid; border-top-color: rgb(221, 221, 221); list-style-type: none; list-style-position: initial; list-style-image: initial; margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; }
@media screen and (min-width: 768px){
.nav-main{ border-top-style: none; border-top-width: initial; border-top-color: initial; display: table; text-align: center; }
}
@media screen and (min-width: 768px){
...
.nav-main a{ border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: rgb(221, 221, 221); display: block; font-size: 0.93333rem; padding-top: 0.8em; padding-right: 0px; padding-bottom: 0.8em; padding-left: 15px; position: relative; -webkit-transition-property: font-size; -webkit-transition-duration: 0.3s; -webkit-transition-timing-function: linear; -webkit-transition-delay: initial; }
@media screen and (max-width: 767px){
.nav-main a{ text-align: left; }
}
@media screen and (min-width: 768px){
.nav-main a{ border-bottom-style: none; border-bottom-width: initial; border-bottom-color: initial; color: rgb(51, 51, 51); font-family: proxima-nova-condensed, 'Arial Narrow', sans-serif; font-size: 1.13333rem; font-weight: 300; letter-spacing: 0.05em; line-height: 1.3125em; padding-top: 0.25em; padding-right: 1.3em; padding-bottom: 0.55em; padding-left: 1.3em; text-transform: uppercase; white-space: nowrap; }
}
@media screen and (min-width: 980px){
.nav-main a{ font-size: 1.33333rem; padding-top: 0.25em; padding-right: 1.45em; padding-bottom: 0.55em; padding-left: 1.45em; }
}
...
.container{ margin-top: 0px; margin-right: auto; margin-bottom: 0px; margin-left: auto; max-width: 1140px; padding-top: 0px; padding-right: 2em; padding-bottom: 0px; padding-left: 2em; position: relative; }
@media screen and (min-width: 768px){
.container{ padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; }
}
@media screen and (min-width: 768px){
...
@media screen and (min-width: 768px){
.main-content img { display: inline-block; padding-top: 0px; padding-right: 0px; padding-bottom: 0px; padding-left: 0px; }
}
...
@media screen and (min-width: 768px){
.img-container { height: 400px; padding-top: 0px; background-size:  ; }
}
@media print{
...
a{ color: rgb(247, 150, 72); }
.header{ background-image: url(../images/nav_green.png); background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgb(51, 51, 51); background-position: 0% 100%; background-repeat: repeat no-repeat; }
.header h1 a{ color: white; }
@media screen and (min-width: 768px){
.header{ background-image: url(../images/nav_green.png); background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgb(49, 49, 49); background-position: 0% 100%; background-repeat: repeat no-repeat; }
.header a{ color: white; }
.nav-main li:first-child{ border-top-style: none; border-right-style: none; border-bottom-style: none; border-left-style: none; border-width: initial; border-color: initial; }
.nav-main li{ border-top-style: none; border-right-style: none; border-bottom-style: none; border-left-style: none; border-width: initial; border-color: initial; }
.nav-main a{ color: white; }
.nav-main .active a{ background-image: url(../images/nav_hover.png); background-attachment: initial; background-origin: initial; background-clip: initial; background-color: initial; background-position: 0% 100%; background-repeat: repeat no-repeat; }
.main-content { min-height: 700px; }
.nav-main .active a::after{ border-top-color: transparent; border-right-color: transparent; border-bottom-color: rgb(247, 150, 72); border-left-color: transparent; }
}
.hero-text li a{ background-image: initial; background-attachment: initial; background-origin: initial; background-clip: initial; background-color: rgb(154, 208, 0); background-position: initial initial; background-repeat: initial initial; }
.main-content.event p.dates { font-size: 2em; }