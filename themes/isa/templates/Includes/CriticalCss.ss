...
h1, h2{ color: rgb(51, 51, 51); font-family: proxima-nova-condensed, 'Arial Narrow', sans-serif; margin: 1em 0px 0.5em; letter-spacing: 1px; line-height: 1.2; font-weight: 600; text-rendering: optimizelegibility; }
...
.header{ background-image: url(../images/nav_green.png); background-color: rgb(51, 51, 51); background-position: 0% 100%; background-repeat: repeat no-repeat; }
.header h1 a{ color: white; }
@media screen and (min-width: 768px){
.header{ background-image: url(../images/nav_green.png); background-color: rgb(49, 49, 49); background-position: 0% 100%; background-repeat: repeat no-repeat; }
.header a{ color: white; }
.nav-main li:first-child{ border: none; }
.nav-main li{ border: none; }
.nav-main a{ color: white; }
.nav-main .active a{ background-image: url(../images/nav_hover.png); background-position: 0% 100%; background-repeat: repeat no-repeat; }
.main-content { min-height: 700px; }
.nav-main .active a::after{ border-color: transparent transparent rgb(247, 150, 72); }
}
.hero-text li a{ background-color: rgb(154, 208, 0); background-position: initial initial; background-repeat: initial initial; }
